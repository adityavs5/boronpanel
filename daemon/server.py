...
OP_TABLE = {
    ...
    "snapshot.destination.operation.queue": snapshot_jobs.queue_destination_operation,
    "snapshot.destination.operation.list": snapshot_jobs.destination_operations,
    "snapshot.destination.inventory": snapshot_jobs.destination_inventory,
    ...
    "snapshot.config.export": snapshot_config.export_configuration,
    "snapshot.config.import": snapshot_config.import_configuration,
    ...
    "db.rename": handlers_database.rename_database,
    "db.export": handlers_database.export_database,
    "db.import": handlers_database.import_database,
    "db.change_password": handlers_database.change_password,
    "db.user.list": handlers_database.list_users,
    "db.user.create": handlers_database.create_user,
    "db.user.change_password": handlers_database.change_user_password,
    "db.user.rename": handlers_database.rename_user,
    "db.user.drop": handlers_database.drop_user,
    "db.user.grant": handlers_database.grant_user,
    "db.user.revoke": handlers_database.revoke_user,
    "db.health": handlers_database.database_health,
...
async def handle_client(reader: asyncio.StreamReader, writer: asyncio.StreamWriter) -> None:
    ...
    if sock is None or not hasattr(socket, "SO_PEERCRED"):
        logger.error("rejecting RPC peer without verifiable kernel credentials")
        writer.close()
        return
    try:
