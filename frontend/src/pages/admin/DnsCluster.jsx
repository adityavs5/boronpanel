...
const EMPTY = { name: '', peer_type: 'directadmin', endpoint: '', username: 'admin', credential: '', verify_tls: true }
...
export default function DnsCluster() {
  ...
  const create = useMutation({
    mutationFn: () => post('/api/v1/admin/dns-cluster/peers', { ...form, credential: form.credential || null }),
    onSuccess: result => {
