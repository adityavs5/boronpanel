...
const synonyms = {
  ...
  '/email/dns': 'email mail dns records mx spf dkim dmarc autodiscover zone editor deliverability',
  '/domains': 'domain subdomain addon parked alias website redirect',
  '/subdomains': 'subdomain child domain website create public html',
