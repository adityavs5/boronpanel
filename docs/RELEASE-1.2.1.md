...
The fix passed the mailbox-guard and updater regression suites (81 tests) and a real Dovecot guard activation/reload on the development server. The full release pipeline and actual 1.1.3-to-1.2.1 self-update remain required release gates.
