...
The fix passed the mailbox-guard and updater regression suites (81 tests), a real Dovecot guard activation/reload on the development server, and the complete release suite (2,659 tests). The actual protected 1.1.3-to-1.2.1 panel self-update also completed successfully without rollback, and the post-update preservation audit passed.
